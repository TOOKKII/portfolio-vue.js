    ...
    >
      <header class="text-center lg:text-left">
        ...
        <p class="text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
          Déterminé, autonome et enthousiaste, avec un an d’expérience
          en tant que développeur, j’ai acquis des compétences en
          informatique et en expérience utilisateur. Persévérant et
          tenace, je recherche une entreprise avec laquelle je pourrais
          partager ma passion et m’engager pleinement
        </p>
        <div class="mt-6 flex justify-center lg:justify-start">
          <Button label="cdi / alternance" />
          <a
            href="/cv_yasser_bouraghda.pdf"
